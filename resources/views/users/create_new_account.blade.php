...
<body id="page-top">
    ...
    <div id="" class="bg-theme1 bg-theme">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <!-- Main Content -->
            <div id="content">
                <form action="{{ url('createaccountstore') }}" method="post">
                        ...
                        <div class="mt-2 mb-5" style="min-height: 900px">
                            <div class="col-md-6 offset-md-3">
                                ...
                                <div class="img-thumbnail p-5 mt-3">
                                    ...
                                    <div class="form-group mt-2">
                                        <label for="formGroupExampleInput">Reference(ID)</label>
                                        <input type="text"
                                            class="form-control @if ($errors->has('reference')) is-invalid @endif"
