    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                <li>
                    ...
                    <a href="#">Transfer Monthly Salary</a>
                </li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">
            <div class="row">
                ...
                <form class="form-horizontal" method="POST" action="{{ url('admin/customer/royalitystore') }}"
                    ...
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">Salary Amount</label>
                        <div class="col-sm-4">
