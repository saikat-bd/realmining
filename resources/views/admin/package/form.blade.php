    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="row">
                ...
                <form class="form-horizontal" method="POST" action="{{ url('admin/settings/packagemanage/store') }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="rabit" name="rabit" />
                            @if ($errors->has('rabit'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('rabit') }}
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="duraction" name="duraction" />
